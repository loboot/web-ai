    ...
    try {
      ...
      Logger.log(
        `初始化创建${role}用户成功、用户名为[${username}]、初始密码为[${
          username === 'super' ? 'nine-super' : '123456'
        }] ==============> 请注意查阅`,
        'DatabaseService'
      );
    } catch (error) {
...
`;
      ...
      const defaultConfig = [
        ...
        {
          configKey: 'registerVerifyEmailTitle',
          configVal: 'BingoAI账号验证',
          public: 0,
          encry: 0,
        },
        {
          ...
          configVal:
            '欢迎使用AI Web团队的产品服务,请在五分钟内完成你的账号激活,点击以下按钮激活您的账号，',
          public: 0,
          encry: 0,
        },
        {
          configKey: 'registerVerifyEmailFrom',
          configVal: 'AI Web团队',
          public: 0,
          encry: 0,
        },
        {
          configKey: 'registerVerifyExpir',
          configVal: '1800',
          public: 0,
          encry: 0,
        },
        {
          configKey: 'registerSuccessEmailTitle',
          configVal: 'BingoAI账号激活成功',
          public: 0,
          encry: 0,
        },
        {
          configKey: 'registerSuccessEmailTeamName',
          configVal: 'BingoAI',
          public: 0,
          encry: 0,
        },
        ...
        {
          configKey: 'registerFailEmailTitle',
          configVal: 'BingoAI账号激活失败',
          public: 0,
          encry: 0,
        },
        {
          configKey: 'registerFailEmailTeamName',
          configVal: 'BingoAI团队',
          public: 0,
          encry: 0,
        },

  ...
  registerBaseUrl: [
    {
      required: true,
      trigger: 'blur',
      message: '请填写注册后端服务基础地址！',
    },
  ],
  registerVerifyEmailTitle: [
    { required: true, trigger: 'blur', message: '请填写注册验证码的邮箱标题' },
  ],
  registerVerifyEmailFrom: [
    {
      required: true,
      trigger: 'blur',
      message: '请填写注册验证码的邮箱来源团队',
    },
  ],
  registerVerifyEmailDesc: [
    {
      required: true,
      trigger: 'blur',
      message: '请填写注册验证码的邮箱正文内容',
    },
  ],
  registerVerifyExpir: [
    { required: true, trigger: 'blur', message: '请填写注册验证码的过期时间' },
  ],
  registerSuccessEmailTitle: [
    { required: true, trigger: 'blur', message: '请填写注册成功页的标题' },
  ],
  registerSuccessEmailTeamName: [
    { required: true, trigger: 'blur', message: '请填写注册成功页的团队名称' },
  ],
  registerSuccessEmaileAppend: [
    {
      required: true,
      trigger: 'blur',
      message: '请填写注册成功页的正文追加内容',
    },
  ],
  registerFailEmailTitle: [
    { required: true, trigger: 'blur', message: '请填写注册失败页的标题名称' },
  ],
  registerFailEmailTeamName: [
    { required: true, trigger: 'blur', message: '请填写注册失败页的团队名称' },
  ],
});
  ...
  <div>
    <page-main>
      <el-alert
        ...
        show-icon
        title="邮件设置说明"
        description="这里的邮件设置是作用于注册发送的激活邮件、您需要先在服务的env文件中配置邮件服务信息、后续将迁移至此。"
        type="success"
      />
    </page-main>
      ...
      >
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="后端服务BASE_URL" prop="registerBaseUrl">
              <el-input
                v-model="formInline.registerBaseUrl"
                placeholder="示例地址: http://ai.xxxx.com 后端服务地址"
                clearable
              />
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item
              label="注册验证码下发邮件标题"
              prop="registerVerifyEmailTitle"
            >
              <el-input
                v-model="formInline.registerVerifyEmailTitle"
                placeholder="默认标题: BINGO AI团队验证码"
                clearable
              />
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item
              label="注册账号验证码有效时间"
              prop="registerVerifyExpir"
            >
              <el-input
                v-model.number="formInline.registerVerifyExpir"
                placeholder="注册验证码的有效时间（默认 30 * 60 = 30分钟）"
                clearable
              >
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item
              label="注册成功通知页标题内容"
              prop="registerSuccessEmailTitle"
            >
              <el-input
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item
              label="注册成功通知页团队名称"
              prop="registerSuccessEmailTeamName"
            >
              <el-input
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item
              label="通知页邮件详情追加内容"
              prop="registerSuccessEmaileAppend"
            >
              <el-input
                v-model="formInline.registerSuccessEmaileAppend"
                type="textarea"
                :rows="3"
                placeholder="默认内容(亲爱的{{ username }},欢迎加入{{ xx }}团队,您是尊贵的{{ 000x }}号用户，你的账号[username] | [email] 已经激活成功)、此处填写内容将追加至默认内容后方。"
                clearable
              />
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item
              label="注册失败通知页团队名称"
              prop="registerFailEmailTeamName"
            >
              <el-input

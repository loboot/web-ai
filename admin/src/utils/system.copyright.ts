...
if (import.meta.env.PROD) {
  ...
  //   console.info('%c由%cBINGO AI%c驱动', copyright_sub_style, copyright_main_style, copyright_sub_style, '\nhttps://ai.jiangly.com')
  // }
  // else {
  //   console.info('%cPowered by%cBINGO AI', copyright_sub_style, copyright_main_style, '\nhttps://ai.jiangly.com')
  // }
}

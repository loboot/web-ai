...
const rules: FormRules = {
  withdrawalAmount: [{ required: true, message: '请填写你的提款金额！' }],
  withdrawalChannels: [{ required: true, message: '请选择你的提款渠道！' }],
  contactInformation: [

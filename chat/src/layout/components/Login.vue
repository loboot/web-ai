  ...
  >
    ...
    >
      ...
      <div class="bg-transparent m-0 flex">
        <div class="h-[600px]" v-if="!isMobile"></div>
        <div
          v-if="disabledReg"
          class="flex-1 bg-white flex justify-center items-center dark:bg-[#34373c] h-[600px]"
        >
          <NResult
            size="small"
            status="403"
        ...
        <div
          v-if="!disabledReg"
          class="flex-1 bg-white dark:bg-[#34373c] h-[600px]"
        >
          <Wechat
